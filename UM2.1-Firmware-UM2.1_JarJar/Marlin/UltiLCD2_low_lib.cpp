...
#define I2C_LED2_ADDRESS 0b1100001
...
uint8_t led2_r, led2_g, led2_b, led2_w;
...
static void i2c_led2_write(uint8_t addr, uint8_t data)
{
    i2c_start();
    i2c_send_raw(I2C_LED2_ADDRESS << 1 | I2C_WRITE);
    i2c_send_raw(addr);
    i2c_send_raw(data);
    i2c_end();
}
...
void lcd_lib_init()
{
    ...
    i2c_led2_write(0, 0x80);//MODE1
    i2c_led2_write(1, 0x1C);//MODE2
    i2c_led2_write(2, led_brightness_level_red);//PWM0
    i2c_led2_write(3, led_brightness_level_green);//PWM1
    i2c_led2_write(4, led_brightness_level_blue);//PWM2
    i2c_led2_write(5, led_brightness_level_white);//PWM3
    i2c_led2_write(6, 0xFF);//GRPPWM
    i2c_led2_write(7, 0x00);//GRPFREQ
    i2c_led2_write(8, 0xAA);//LEDOUT
...
void lcd_lib_led2_color(uint8_t r, uint8_t g, uint8_t b, uint8_t w)
{
    led_brightness_level_red = r;
    led_brightness_level_green = g;
    led_brightness_level_blue = b;
    led_brightness_level_white = w;
}
