...
int first_flow_d = 100;
int first_flow_n = 100;
int first_flow_b = 100;

int support_flow_d = 100;
int support_flow_n = 100;
int support_flow_b = 100;

int interfacetop_flow_d = 100;
int interfacetop_flow_n = 100;
int interfacetop_flow_b = 100;

int bottom_flow_d = 100;
int bottom_flow_n = 100;
int bottom_flow_b = 100;

int outer_flow_d = 100;
int outer_flow_n = 100;
int outer_flow_b = 100;

int inner_flow_d = 100;
int inner_flow_n = 100;
int inner_flow_b = 100;

int infill_flow_d = 100;
int infill_flow_n = 100;
int infill_flow_b = 100;

int top_flow_d = 100;
int top_flow_n = 100;
int top_flow_b = 100;

int interfacebot_flow_d = 100;
int interfacebot_flow_n = 100;
int interfacebot_flow_b = 100;

int travel_flow_d = 100;
int travel_flow_n = 100;
