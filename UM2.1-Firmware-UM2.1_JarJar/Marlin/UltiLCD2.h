...
extern uint8_t led_brightness_level_red;
extern uint8_t led_brightness_level_green;
extern uint8_t led_brightness_level_blue;
extern uint8_t led_brightness_level_white;
